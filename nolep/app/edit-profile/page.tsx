...
export default function EditProfile() {
  ...
  return (
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        const isConfirmed = window.confirm("Apakah kamu sudah yakin untuk menyimpan data?");
        if (isConfirmed) {
                ...
                <div className="bg-white shadow-2xl rounded-2xl p-10 w-full max-w-6xl flex gap-10">
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 space-y-4">
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                <label className="block text-base font-semibold mb-1 cursor-text">First Name</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-base font-semibold mb-1 cursor-text">Last Name</label>
                                <input
                                    type="text"
                                    className="border w-full py-4 px-2 rounded-lg text-lg cursor-text"
                                    value={formData.lastName}
                        ...
                        {[
                            ...
                            <div key={name}>
                                <label className="block text-base font-semibold mb-1 cursor-text">{label}</label>
                                <input
                                    type={type}
                                    className="border w-full py-4 px-2 rounded-lg text-lg cursor-text"
                                    value={formData[name as keyof typeof formData]}
                        ...
                        <div>
                            <label className="block text-base font-semibold mb-1 cursor-text">Password</label>
